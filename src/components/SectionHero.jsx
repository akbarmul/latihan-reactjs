    ...
    <>
      <main>
        ...
        <section className="container flex gap-8 lg:flex-row flex-col">
          ...
          <div className="w-full">
            <h1 class="text-5xl mb-8 text-bold">Incredible</h1>
            <p class="mb-7">
            ...
            <ButtonArrow>
              Learn More<span class="iconify mt-1" data-icon="ep:right"></span>
            </ButtonArrow>
          </div>
        </section>
        {/* features sec */}
        <section className="my-10 bg-gray-200" id="feat">
          <div className="container p-20">
            <div className="w-1/3 mx-auto my-10">
              <h1 class="text-4xl font-bold text-center">Our service features</h1>
              <p class="text-center">Aliquid officiis cumque sunt sint. Et quo culpa. Enim sed natus molestiae fugiat cum consequatur quia sunt.</p>
            </div>
            <div className="grid lg:grid-cols-4 gap-5 sm:grid-cols-2 grid-cols-1">
              <CardFeatures>
                <h1 class="text-3xl font-bold mb-3">Incredible</h1>
                <p>Adipisci tempora pariatur modi recusandae. Omnis neque dolorum. Natus facere voluptatem.</p>
              </CardFeatures>
              <CardFeatures>
                <h1 class="text-3xl font-bold mb-3">Generic</h1>
                <p>Adipisci tempora pariatur modi recusandae. Omnis neque dolorum. Natus facere voluptatem.</p>
              </CardFeatures>
              <CardFeatures>
                <h1 class="text-3xl font-bold mb-3">Awesome</h1>
                <p>Adipisci tempora pariatur modi recusandae. Omnis neque dolorum. Natus facere voluptatem.</p>
              </CardFeatures>
              <CardFeatures>
                <h1 class="text-3xl font-bold mb-3">Refined</h1>
                <p>Adipisci tempora pariatur modi recusandae. Omnis neque dolorum. Natus facere voluptatem.</p>
              </CardFeatures>
            </div>
          </div>
        ...
        <section className="my-5">
          <div className="container py-10">
            <div class="w-1/3 mx-auto my-10">
              <h1 class="text-4xl font-bold text-center">Testimonials</h1>
              <p class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, repellendus numquam.</p>
            </div>
        ...
        <section className="container lg:my-20 my-5">
          <div className="bg-green-700 lg:py-32 py-10">
            <div className="lg:w-1/3 w-full lg:mx-auto mx-auto lg:px-0 px-5">
              <h1 class="text-white text-3xl font-bold text-center mb-3">Start your free trial</h1>
              <p class="text-white text-center mb-10">Trial period - 14 days, no credit card required</p>
              <div className="flex lg:flex-row flex-col">
                <input class="w-full lg:py-3 py-3 lg:px-2 px-10 rounded-l-lg" type="text" placeholder="Your email address"></input>
                <button class="flex-shrink-0 transition-all rounded-r-lg py-2 px-3 bg-green-600 text-white font-bold hover:bg-green-800 active:bg-green-900 focus:ring focus:ring-green-400">Get Started</button>
              </div>
            </div>
          </div>
        </section>
